        ...
        <div className="flex flex-column items-center">
          ...
          <div className="tc">
            ...
            <P extraStyles={pStyle}>
              Rachel Cope has over 6 years of experience in UI, UX, and product design.
              She co-founded a web app and has worked as a design consultant with dozens
              of clients across the US, London, Sweden, and Mexico.
            </P>
            <P extraStyles={pStyle}>
              Matt Smith is a full-stack developer.
              He has developed software for the US Airforce
              , Department of Veteran Affairs, numerous startups
